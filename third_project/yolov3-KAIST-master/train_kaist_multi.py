...
wdir = '/hpc/home/federico.rovighi/3Dperception/yolov3-KAIST-master/weights/'  # weights dir
last = wdir + 'multiple_step/10epochs_multiple/last.pt' 
best = wdir + 'best.pt'
results_file = 'results.txt'

print('hyperparameter step')
...
def train(hyp):
    ...
    nc = 3 #if opt.single_cls else int(data_dict['classes'])  # number of classes
    ...
    print('Starting training for %g epochs from epochs number %g ...' % (epochs, start_epoch))
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            if opt.multi_scale:
                if ni / accumulate % 1 == 0:  #  adjust img_size (67% - 150%) every 1 batch
                    img_size = random.randrange(grid_max + 1, grid_min) * gs
            ...
            #loss_tensor = loss  # sostituisci con il vero tensore della perdita
            ...
            # Backward
            #scaled_loss = loss * batch_size / 64  # scale loss
    ...
    if final_epoch:
        ...
        best_weight = '/hpc/home/federico.rovighi/3Dperception/yolov3-KAIST-master/weights/best.pt'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/kaist/kaist_night_all.data', help='*.data path')
    parser.add_argument('--multi-scale', action='store_true', help='adjust (67%% - 150%%) img_size every 10 batches')
    parser.add_argument('--img-size', nargs='+', type=int, default=[640, 512], help='[min_train, max-train, test]')
    parser.add_argument('--rect', action='store_true', help='rectangular training')
    parser.add_argument('--resume', action='store_false', help='resume training from last.pt')  # MODIFIED HERE
    parser.add_argument('--nosave', action='store_true', help='only save final checkpoint')
    parser.add_argument('--notest', action='store_true', help='only test final epoch')
    parser.add_argument('--evolve', action='store_true', help='evolve hyperparameters')
    parser.add_argument('--bucket', type=str, default='', help='gsutil bucket')
    parser.add_argument('--cache-images', action='store_true', help='cache images for faster training')
    parser.add_argument('--weights', type=str, default='/hpc/home/federico.rovighi/3Dperception/yolov3-KAIST-master/weights/multiple_step/20epochs_multipleV1/last.pt', help='initial weights path')
